...
export const HeroTexts = {
  secondText: "Reaching Hearts, Renewing Lives, Transforming Nations.",
  thirdText:
    "NCG is a Christian-based ministry transforming lives through God’s Word and impactful service across West Nile, neighboring regions, and beyond.",
  firstButton: "Donate",
...
export const FooterTexts = {
  underLogoText: "Empowering Communities Through Faith and Practical Work.",
  quickLinks: {
    caption: "Quick Links",
    links: [
      {
  ...
  contacts: {
    ...
    links: [
      {
        name: "newcreationgathering2017@gmail.com",
        url: "/",
      },
      {
        name: "+256780146549",
